var Terminal = (function() {
    ...
    var runCommand = function(terminal, cmd, args) {
        terminal.innerHTML += (self.commands[cmd.replace(/[^a-z0-9_\?-]/gmi, '')](args));
    };
    ...
    self.init = function(elem, commands) {
        ...
        elem.addEventListener("keypress", function(event) {
			...
			if(event.keyCode == 13) $("p:last-of-type #timestamp").html(new Date().toLocaleTimeString(undefined, { hour: '2-digit', minute: '2-digit', second: '2-digit'}));
        });
